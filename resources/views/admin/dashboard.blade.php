...
@section('content')
    <div class="admin-stat-grid">
        <a href="{{ route('admin.portfolio.index') }}" class="admin-stat-card" style="text-decoration: none;">
        ...
        <a href="{{ route('admin.blog-posts.index') }}" class="admin-stat-card" style="text-decoration: none;">
            <div class="admin-stat-card__icon">
        ...
        <a href="{{ route('admin.bookings.index', ['status' => 'pending']) }}" class="admin-stat-card" style="text-decoration: none;">
            <div class="admin-stat-card__icon">
        ...
        <a href="{{ route('admin.bookings.index') }}" class="admin-stat-card" style="text-decoration: none;">
            <div class="admin-stat-card__icon">
    ...
    <div style="margin-top: 32px; display: flex; gap: 16px; flex-wrap: wrap;">
        ...
        <a href="{{ route('admin.blog-posts.create') }}" class="btn btn-outline">New Blog Post</a>
        <a href="{{ route('admin.bookings.index') }}" class="btn btn-outline">Review Bookings</a>
    </div>
@endsection