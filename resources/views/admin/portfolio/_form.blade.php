...
<div class="tmo-form__field">
    ...
    @if (!empty($portfolio->cover_image))
        <div class="admin-current-image">
            ...
            <span style="font-size: 13px; color: var(--color-muted);">Current cover image. Upload a new file to replace it.</span>
        </div>
    @endif
            ...
            @foreach ($portfolio->gallery as $image)
                <figure>
                    ...
                    <figcaption>
                        ...
                        <label for="remove-{{ $loop->index }}" style="margin: 0;">Remove</label>
                    </figcaption>
                </figure>
            @endforeach
        </div>
